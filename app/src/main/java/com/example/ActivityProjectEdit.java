...
import com.example.handasy.fragments.EditProject1;
...
public class ActivityProjectEdit extends FragmentActivity {

    public static ProjectData projectDataBase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        projcetPostion = intent.getIntExtra("postion", -1);
        String kind = "";
        projectDataBase = MyProjects.projectList.get(projcetPostion);
        projectID = projectDataBase.projectId;
        Log.e("error", projcetPostion + "");
        Log.e("error", projectDataBase.toString() + "");
        editProject();
    ...
    private void editProject() {
        ...
        EditProject1 fragment = new EditProject1();
